...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll(".room-container").forEach((room) => {
        room.addEventListener("click", () => {
            ...
            console.log("Room clicked:", roomType);  // Debugging to check if click works

            // Show the modal and ensure display is set to block
            modal.style.display = "block"; // Debug to ensure the modal appears

            // Update modal content (uncomment this once you confirm modal appears)
    ...
    closeBtn.onclick = function() {
        console.log("Close button clicked"); // Debugging if close is working
        modal.style.display = "none";
    }

    // Close modal when clicking outside the modal content
    window.onclick = function(event) {
        console.log("Clicked target:", event.target);  // Debugging what is clicked
